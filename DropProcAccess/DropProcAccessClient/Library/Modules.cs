...
using DropProcAccessClient.Interop;
...
namespace DropProcAccessClient.Library
{
    ...
    {
        public static bool RemoveProcessGuard()
        {
            NTSTATUS ntstatus;
            ...
            do
            {
                ...
                ntstatus = NativeMethods.NtDeviceIoControlFile(
                    ...
                    IntPtr.Zero,
                    out IO_STATUS_BLOCK _,
                    Globals.IOCTL_REMOVE_PROCESS_GUARD,
                    IntPtr.Zero,
                    0u,
                    IntPtr.Zero,
                    0u);
                ...
                if (ntstatus != Win32Consts.STATUS_SUCCESS)
                    ...
                    Console.WriteLine("[+] Object Notify Callback is removed successfully.");
            } while (false);
        ...
        public static bool SetProcessGuard(int pid)
        {
            NTSTATUS ntstatus;
            ...
            do
            {
                ...
                ntstatus = NativeMethods.NtDeviceIoControlFile(
                    ...
                    IntPtr.Zero,
                    out IO_STATUS_BLOCK _,
                    Globals.IOCTL_SET_PROCESS_GUARD,
                    pInBuffer,
                    4u,
                    IntPtr.Zero,
                    0u);
                ...
                if (ntstatus != Win32Consts.STATUS_SUCCESS)
                    ...
                    Console.WriteLine("[+] Handle for PID {0} will be dropped to SYNCHRONIZE | PROCESS_QUERY_LIMITED_INFORMATION.", pid);
            } while (false);
