...
using BlockImageLoadClient.Handler;

namespace BlockImageLoadClient
{
    internal class BlockImageLoadClient
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                options.SetTitle("BlockImageLoadClient - Client for BlockImageLoadDrv.");
